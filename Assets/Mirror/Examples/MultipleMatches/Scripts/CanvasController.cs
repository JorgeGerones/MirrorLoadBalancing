...
namespace Mirror.Examples.MultipleMatch
{
    ...
    public class CanvasController : MonoBehaviour
    {
        ...
        [SerializeField] private ServerCom serverCom;
        ...
        public void RequestCreateMatch()
        {
            ...
            DebugServer.Log($"player id = {pId}");

            NetworkClient.Send(new ServerMatchMessage { serverMatchOperation = ServerMatchOperation.Create, userId = pId });
        }
        ...
        void OnServerCreateMatch(NetworkConnectionToClient conn, ServerMatchMessage msg)
        {
            ...
            serverCom.Create(newMatchId, msg.userId);
